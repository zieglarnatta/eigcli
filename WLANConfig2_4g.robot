...
Execute interface wifi 2.4g to Enter WLAN 2.4g
    [Tags]                      Config  interface_wifi_2_4g     interface_wifi_2_4g_enter
    [Documentation]             Fire off the interface wifi 2.4g  and then verify it's in WLAN 2.4 g
    #configure -> interface wifi 2.4g -> conn 
    ${output}=                 write   configure     #to get into Global Connfiguration -> System configuration
    #sleep                       1
    ${output}=                 write   interface wifi 2.4g     #to get into Global Connfiguration -> System configuration -> WLAN 2.4g

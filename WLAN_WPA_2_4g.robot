...
SSID Hide enabled
    [Tags]                      Config  interface_wifi_2_4g  interface_wifi_2_4g_ssid_hide
...
SSID broadcast
    [Tags]                      Config  interface_wifi_2_4g  interface_wifi_2_4g_ssid_broadcast
...
Password
    [Tags]                      Config  interface_wifi_2_4g  interface_wifi_2_4g_password
...
Rekey key rotation interval
    [Tags]                      Config  interface_wifi_2_4g  interface_wifi_2_4g_rekey
    [Documentation]             Fire off the password and check that password is updated
